...
def run_test_make_less_simple_string():
    ...
    # Test 2 (add your test here):
    expected = '-2--1-0-1-2-3-4'
    actual = make_less_simple_string(-2, 4)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    allrect = []
    for k in circles:
        holding = rg.Rectangle(rg.Point(k.center.x-k.radius,k.center.y-k.radius),rg.Point(k.center.x+k.radius,k.center.y+k.radius))
        allrect += [holding]
    return allrect
